...
namespace Voltaic.Serialization.Json.Tests
{
    public class DateTimeTests : BaseTest<DateTime>
    {
        public static IEnumerable<object[]> GetData()
        {
            ...
            yield return Fail("0001-01-01T00:00:00.0000000Z"); // Unquoted
            yield return Fail("\"0001-01-01T00:00:00.0000000Z"); // Unclosed quote
        }
    ...
    public class DateTimeOffsetTests : BaseTest<DateTimeOffset>
    {
        public static IEnumerable<object[]> GetData()
        {
            ...
            yield return Fail("0001-01-01T00:00:00.0000000+00:00"); // Unquoted
            yield return Fail("\"0001-01-01T00:00:00.0000000+00:00"); // Unclosed quote
        }
    ...
    public class TimeSpanTests : BaseTest<TimeSpan>
    {
        public static IEnumerable<object[]> GetData()
        {
            ...
            yield return Fail("-10675199.02:48:05.4775808"); // Unquoted
            yield return Fail("\"-10675199.02:48:05.4775808"); // Unclosed quote
        }
