...
namespace Wumpus.Entities
{
    ...
    public enum GuildPermissions : ulong
    {
        ...
        /// <summary> Allows kicking <see cref="User"/>s. </summary>
        KickMembers = 0x00000002,
        /// <summary> Allows banning <see cref="User"/>s. </summary>
        ...
        /// <summary> Allows for modification of other <see cref="User"/>'s nicknames. </summary>
