...
namespace Voltaic
{
    // https://github.com/dotnet/corefxlab/blob/master/src/System.Text.Utf8String/System/Text/Utf8String.cs
    ...
    public sealed class Utf8String // : IBufferFormattable
    {
        ...
        static readonly Utf8String _empty = new Utf8String(string.Empty);
        ...
        public static Utf8String Empty => _empty;
